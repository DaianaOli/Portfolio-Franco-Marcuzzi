        ...
        <nav className="bg-gray-100 text-black dark:text-white dark:bg-zinc-800 fixed w-full z-10 ">
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div className="relative flex items-center h-16">
                    ...
                    <h1 className="text-black dark:text-white text-center font-serif  text-4xl block lg:hidden h-12 w-auto ">FM</h1>
                    <h1 className="text-black dark:text-white -center font-serif  text-4xl hidden lg:block h-12 w-auto ">FM</h1>
</div>
<div className="hidden sm:block sm:ml-6">
  <div className="flex space-x-4 items-center">
  <a
                                    href="#home"
                                    className="hover:border-b border-black  dark:border-white 700 px-3 py-2  text-sm font-medium"
                                    aria-current="page"
                                > Menu
                                </a>
                                <a
