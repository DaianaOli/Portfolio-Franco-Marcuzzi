    ...
    <section>
      <div className="page flex md:flex-row flex-col h-screen items-center  ">
          ...
          <div className=" grid grid-cols-9 my-20 md:my-0 md:mx-5  lg:my-0  w-screen h-2/5 rounded-md overflow-hidden shadow-lg font-extrabold font-serif text-2xl sm:text-4xl lg:text-6xl group">
            {tablets.front.map((e, index) => (
              ...
              >
                ...
                <div
                  className=" bg-zinc-800/60 absolute inset-0 h-full w-full  [transform:rotateY(180deg)]  [backface-visibility:hidden]"
                  style={{
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
        ...
        <div className="bg-slate-200 flex px-0 mx-0  items-center  w-screen lg:w-1/3 hover md:w-2/5 h-2/5 md:h-screen lg:h-screen relative group">
          ...
          >
            <h1 className=" text-2xl md:text-3xl lg:text-4xl shadow-sm font-mono tran group-hover:translate-y-5 lg:group-hover:translate-y-10 duration-1000 ">
              {t(
                "Desarrollador Backend con experiencia en múltiples tecnologías"
              )}{" "}
              &#x1F9D1;&#x200D;&#x1F4BB;
            </h1>
            <p className="mt-14 opacity-0 group-hover:translate-y-5 lg:group-hover:translate-y-10 group-hover:opacity-100 duration-1000 delay-500">
              {" "}
              {t(
                "Me especializo en la creación de aplicaciones robustas y escalables."
              )}
            </p>
          </div>
          <img
